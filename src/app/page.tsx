...
const DEFAULT_ITEMS: RegistryItem[] = [
  { id: "1",  name: "KitchenAid Stand Mixer",       category: "Kitchen",     description: "7-Quart Bowl-Lift Stand Mixer in Empire Red",           price: "$549",  store: "Williams Sonoma",      url: "https://www.williams-sonoma.com/products/kitchenaid-bowl-lift-stand-mixer/",                             purchased: false },
  { id: "2",  name: "Le Creuset Dutch Oven",         category: "Kitchen",     description: "5.5 Qt Round Dutch Oven in Marseille Blue",             price: "$420",  store: "Sur La Table",         url: "https://www.surlatable.com/le-creuset-signature-round-dutch-oven/",                                      purchased: false },
  { id: "3",  name: "Frette Bed Linens",             category: "Bedroom",     description: "King-size percale cotton sheet set in ivory",           price: "$380",  store: "Frette",               url: "https://www.frette.com/en-us/bedding/sheets/",                                                           purchased: false },
  { id: "4",  name: "Vitamix Blender",               category: "Kitchen",     description: "A3500 Ascent Series Smart Blender",                     price: "$620",  store: "Vitamix",              url: "https://www.vitamix.com/us/en_us/shop/a3500",                                                            purchased: false },
  { id: "5",  name: "Tiffany Picture Frames",        category: "Décor",       description: "Sterling silver double frame, 4×6",                     price: "$295",  store: "Tiffany & Co.",        url: "https://www.tiffany.com/accessories/frames/",                                                            purchased: false },
  { id: "6",  name: "Nespresso Vertuo Machine",      category: "Kitchen",     description: "Vertuo Next Coffee and Espresso Maker",                  price: "$199",  store: "Williams Sonoma",      url: "https://www.williams-sonoma.com/products/nespresso-vertuonext/",                                         purchased: false },
  { id: "7",  name: "Linen Tablecloth Set",          category: "Dining",      description: "90×132 in. European linen in ivory with napkins (12)", price: "$260",  store: "Restoration Hardware", url: "https://www.restorationhardware.com/catalog/category/products.jsp?categoryId=cat4640026",                 purchased: false },
  { id: "8",  name: "All-Clad Cookware Set",         category: "Kitchen",     description: "10-piece D3 Stainless Steel Set",                       price: "$799",  store: "Williams Sonoma",      url: "https://www.williams-sonoma.com/products/all-clad-d3-stainless-steel-10-piece-cookware-set/",            purchased: false },
  { id: "9",  name: "Cashmere Throw Blanket",        category: "Living Room", description: "Pure cashmere woven throw in champagne",                price: "$340",  store: "Loro Piana",           url: "https://www.loropiana.com/en/eshop/c/cashmere-blankets",                                                 purchased: false },
  { id: "10", name: "Smeg Toaster",                  category: "Kitchen",     description: "2-Slice Toaster in Cream",                              price: "$199",  store: "Smeg",                 url: "https://www.smeg.com/us/products/small-appliances/toasters/",                                            purchased: false },
  { id: "11", name: "Monogrammed Towel Set",         category: "Bathroom",    description: "Egyptian cotton bath towels, set of 6, monogrammed",    price: "$180",  store: "Pottery Barn",         url: "https://www.potterybarn.com/products/monogrammed-bath-towels/",                                          purchased: false },
  { id: "12", name: "Champagne Flutes (set of 12)", category: "Barware",     description: "Riedel crystal flutes, hand-blown",                     price: "$240",  store: "Riedel",               url: "https://www.riedel.com/en-us/shop/champagne-glasses",                                                    purchased: false },
];
